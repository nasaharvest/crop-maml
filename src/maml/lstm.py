...
class Classifier(nn.Module):
    def __init__(
        ...
        self.batchnorm = nn.BatchNorm1d(num_features=classifier_vector_size)
        ...
        for i in range(num_classification_layers):
            ...
            if i < (num_classification_layers - 1):
                ...
                classification_layers.append(nn.BatchNorm1d(num_features=classifier_vector_size))
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        return torch.sigmoid(self.classifier(base))
