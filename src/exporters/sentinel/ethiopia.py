...
from src.processors.ethiopia import EthiopiaProcessor

from typing import Optional


class EthiopiaSentinelExporter(BaseSentinelExporter):

    dataset = "earth_engine_ethiopia"
    ...
    def load_labels(self) -> pd.DataFrame:
        ...
        ethiopia = self.data_folder / "processed" / EthiopiaProcessor.dataset / "data.geojson"
        assert ethiopia.exists(), "Ethiopia processor must be run to load labels"
        return geopandas.read_file(ethiopia)[["lat", "lon"]]
